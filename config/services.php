...
return [
    ...
    */
    ...
    'omnidimension' => [
        ...
        'cache_tab_bulk_details_ttl' => (int) env('OMNIDIMENSION_CACHE_TAB_BULK_DETAILS_TTL', 45),
        'cache_tab_whatsapp_followup_ttl' => (int) env('OMNIDIMENSION_CACHE_TAB_WHATSAPP_FOLLOWUP_TTL', 60),
        'cache_tab_voice_cron_ttl' => (int) env('OMNIDIMENSION_CACHE_TAB_VOICE_CRON_TTL', 30),
        'cache_tab_call_logs_ttl' => (int) env('OMNIDIMENSION_CACHE_TAB_CALL_LOGS_TTL', 45),
        'cache_tab_api_logs_ttl' => (int) env('OMNIDIMENSION_CACHE_TAB_API_LOGS_TTL', 30),
