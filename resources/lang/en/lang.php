...
',
  ...
  'WhatsApp_booking_automation_log_open' => 'View automation message log (sent / errors / delivery)',
  ...
  'WhatsApp_tab_payment_change' => 'When payment status is updated',
  'WhatsApp_tab_ledger_payment_messages' => 'Payment messages (ledger)',
  'WhatsApp_template_ledger_payment_messages_hint_meta' => 'Templates for manual provider/customer payment reminders and automatic messages after you collect from or pay a provider on the provider Payment tab. Map Meta template variables to the placeholders listed in the booking template help (including provider/customer pending balance and amounts).',
  ...
  'WhatsApp_template_payment_change_hint' => 'When paid or due payment status changes, WhatsApp sends the left message to the customer and the right message to the provider.',
  ...
  'Send_booking_WhatsApp_messages' => 'Send booking WhatsApp messages (requires Cloud API configured)',
