...
',
  ...
  'WhatsApp_booking_marketing_templates_path_hint' => 'Marketing → Templates: /admin/whatsapp/marketing/templates (requires permission to view marketing templates).',
  ...
  'WhatsApp_tab_booking_messages' => 'Booking Messages',
