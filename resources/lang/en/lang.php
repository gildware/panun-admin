...
_Message' => 'Customer notification for provider bid offer
 Message',
  ...
  'Customer_pending_bad_debt_loss_making_hint' => 'Total the customer still owes on bookings marked as loss-making (partial payment vs full booking total). Canceled and refunded bookings are not counted.',
...
',
  ...
  'Configure_reopened_scenarios_help' => 'While a reopen case is open, you cannot set the booking to Completed until you choose a path here: either complete after adjusting the booking, or cancel with a split refund.',
  ...
  'Apply_disputed_refund_and_close' => 'Apply refund & close reopen case',
  ...
  'Bfs_financial_settlement_only_while_ongoing' => 'Special financial settlement can only be configured while the booking is ongoing.',
