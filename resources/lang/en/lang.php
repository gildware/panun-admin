...
',
  ...
  'WhatsApp_booking_template_help' => 'Set customer (left) and provider (right) messages for new bookings and for status changes. When enabled, each non-empty template is sent to that party if a valid phone is available. Use the variables below; they are replaced with live booking data.',
