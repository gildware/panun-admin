...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{translate('Panun Kaergar Software Installation')}}</h2>
        <h6 class="fw-normal">{{translate('Please proceed step by step with proper data according to instructions')}}</h6>
    </div>

    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Panun Kaergar Software Installation"
                            ...
                            <div class="col-md-12">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="web_name"
                                           required placeholder="{{translate('Ex: Panun Kaergar')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
