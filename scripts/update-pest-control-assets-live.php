...
/**
 * Re-upload pest control service images + variant icons on live (no variant recreate).
 *
 * LIVE_DB_PASSWORD='...' php artisan tinker scripts/update-pest-control-assets-live.php
 *
 * Optional: SERVICE_SLUG=apartment-cockroach-control
...
foreach ($serviceSlugs as $slug) {
    ...
    if (! $variantsOnly) {
        ...
        if ($spec) {
            $content = PestControlContentBuilder::build($spec);
