#!/usr/bin/env python3
"""Post-process AI-generated cleaning category + variant icons."""
...
PROMPTS = ROOT / "assets" / "data" / "cleaning-icon-prompts.json"
...
def main() -> None:
    if not PROMPTS.is_file():
        subprocess.run([sys.executable, str(ROOT / "assets" / "cleaning_icon_prompts.py")], check=True)
