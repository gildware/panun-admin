...
/**
 * Update Book Site Inspection variants for all Carpentry Repairs services on live.
 *
 * LIVE_DB_PASSWORD='...' php artisan tinker scripts/update-carpentry-repairs-variants-live.php
 */
...
$liveConnection = 'live_repair_variants';
...
$services = [
    'door-repair' => [
        ...
        'description' => 'Verified carpenter inspects door damage, hinges, frame alignment and repair scope on site.',
        'note' => 'This inspection fee will be adjusted against your final door repair bill if you proceed with the full service through Panun Kaergar.',
    ],
    'furniture-repair' => [
        'old_keys' => ['Book-at-Home-Consultation', 'Book--at-Home-Consultation'],
        'description' => 'Verified carpenter inspects furniture damage, joints and fittings on site.',
        'note' => 'This inspection fee will be adjusted against your final furniture repair bill if you proceed with the full service through Panun Kaergar.',
    ],
    'window-repair' => [
        'old_keys' => ['Book-at-Home-Consultation', 'Book--at-Home-Consultation'],
        'description' => 'Verified carpenter inspects window frame, panels and alignment on site.',
        'note' => 'This inspection fee will be adjusted against your final window repair bill if you proceed with the full service through Panun Kaergar.',
    ],
    'wardrobe-repair' => [
        'old_keys' => ['Book-at-Home-Consultation', 'Book--at-Home-Consultation'],
        'description' => 'Verified carpenter inspects wardrobe panels, hinges and sliding issues on site.',
        'note' => 'This inspection fee will be adjusted against your final wardrobe repair bill if you proceed with the full service through Panun Kaergar.',
    ],
    'kitchen-cabinet-repair' => [
        'old_keys' => ['Book-at-Home-Consultation', 'Book--at-Home-Consultation'],
        'description' => 'Verified carpenter inspects cabinet damage, hinges and alignment on site.',
        'note' => 'This inspection fee will be adjusted against your final kitchen cabinet repair bill if you proceed with the full service through Panun Kaergar.',
    ],
    'wooden-panel-repair' => [
        'old_keys' => ['Book-at-Home-Consultation', 'Book--at-Home-Consultation'],
        'description' => 'Verified carpenter inspects wall panels, cracks and loose fittings on site.',
        'note' => 'This inspection fee will be adjusted against your final wooden panel repair bill if you proceed with the full service through Panun Kaergar.',
    ],
    'roof-repair' => [
        'old_keys' => ['Book-at-Home-Consultation', 'Book--at-Home-Consultation'],
        'description' => 'Verified carpenter inspects roof structure, damaged sections and support points on site.',
        'note' => 'This inspection fee will be adjusted against your final roof repair bill if you proceed with the full service through Panun Kaergar.',
    ],
];
