#!/usr/bin/env python3
"""Post-process AI-generated electrical category + variant icons."""
...
PROMPTS = ROOT / "assets" / "data" / "electrical-icon-prompts.json"
...
def main() -> None:
    if not PROMPTS.is_file():
        subprocess.run([sys.executable, str(ROOT / "assets" / "electrical_icon_prompts.py")], check=True)
