#!/usr/bin/env python3
"""Post-process AI-generated home-appliances category + variant icons."""
...
PROMPTS = ROOT / "assets" / "data" / "home-appliances-icon-prompts.json"
...
def main() -> None:
    if not PROMPTS.is_file():
        subprocess.run([sys.executable, str(ROOT / "assets" / "home_appliances_icon_prompts.py")], check=True)
