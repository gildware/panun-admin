#!/usr/bin/env python3
"""Post-process AI-generated Generators category + variant icons."""
...
PROMPTS = ROOT / "assets" / "data" / "generators-icon-prompts.json"
...
def main() -> None:
    ...
    print("Done. Run make_theme_pairs for generators next.")
