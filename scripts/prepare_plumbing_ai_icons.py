#!/usr/bin/env python3
"""Post-process AI-generated plumbing category + variant icons."""
...
PROMPTS = ROOT / "assets" / "data" / "plumbing-icon-prompts.json"
...
def main() -> None:
    if not PROMPTS.is_file():
        subprocess.run([sys.executable, str(ROOT / "assets" / "plumbing_icon_prompts.py")], check=True)
