#!/usr/bin/env python3
"""Copy photorealistic men's salon service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "mens-salon-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} men's salon services.")
    if missing:
