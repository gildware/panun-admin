#!/usr/bin/env python3
"""Copy photorealistic electrical service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "electrical-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} electrical services.")
    if missing:
