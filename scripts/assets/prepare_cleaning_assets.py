#!/usr/bin/env python3
"""Copy photorealistic cleaning service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "cleaning-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} cleaning services.")
    if missing:
