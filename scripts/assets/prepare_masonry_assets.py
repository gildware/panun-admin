#!/usr/bin/env python3
"""Copy photorealistic masonry service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "masonry-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} masonry services.")
    if missing:
