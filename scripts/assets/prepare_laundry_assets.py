#!/usr/bin/env python3
"""Copy photorealistic laundry service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "laundry-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} laundry services.")
    if missing:
