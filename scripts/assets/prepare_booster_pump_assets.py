#!/usr/bin/env python3
"""Copy photorealistic booster pump service images from Cursor assets folder."""
...
SLUGS = ["booster-pump-install", "booster-pump-repair"]
...
def main() -> None:
    ...
    print(f"\nPrepared {len(SLUGS)} booster pump services.")
