#!/usr/bin/env python3
"""Copy photorealistic curtain rod service images from Cursor assets folder."""
...
def copy_service_image(kind: str) -> None:
...
def main() -> None:
    copy_service_image("thumbnail")
    copy_service_image("cover")
    print("Prepared curtain rod installation photos.")
