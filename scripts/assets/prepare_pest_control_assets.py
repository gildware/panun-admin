#!/usr/bin/env python3
"""
Copy photorealistic pest control service images from Cursor assets folder.
Same pipeline as prepare_repair_assets.py — 1024x1024 thumb, 1536x1024 cover.
"""
...
CATALOG = ROOT.parent / "data" / "pest-control-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} pest control services.")
    if missing:
