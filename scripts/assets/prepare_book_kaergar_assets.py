#!/usr/bin/env python3
"""Copy photorealistic Book Kaergar service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "book-kaergar-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} Book Kaergar services.")
    if missing:
