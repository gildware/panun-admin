#!/usr/bin/env python3
"""Copy photorealistic home-appliances service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "home-appliances-catalog.php"
...
def main() -> None:
    ...
    slugs = [slug for slug in load_slugs() if not slug.startswith("generator-")]
    missing = []
    prepared = 0
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} home-appliances services.")
    if missing:
