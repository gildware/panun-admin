#!/usr/bin/env python3
"""Copy photorealistic Aluminium & Steel service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "aluminium-steel-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} aluminium & steel services.")
    if missing:
