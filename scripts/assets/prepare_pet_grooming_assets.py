#!/usr/bin/env python3
"""Copy photorealistic pet grooming service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "pet-grooming-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} pet grooming services.")
    if missing:
