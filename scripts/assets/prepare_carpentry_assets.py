#!/usr/bin/env python3
"""Copy photorealistic carpentry service images from Cursor assets folder."""
...
CATALOG = ROOT.parent / "data" / "carpentry-catalog.php"
...
def main() -> None:
    ...
    print(f"\nPrepared {prepared}/{len(slugs)} carpentry services.")
    if missing:
