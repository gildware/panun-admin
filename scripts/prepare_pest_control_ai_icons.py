#!/usr/bin/env python3
"""Post-process AI-generated pest control category + variant icons (like prepare_laundry_ai_icons.py)."""
...
PROMPTS = ROOT / "assets" / "data" / "pest-control-icon-prompts.json"
CATALOG = ROOT / "data" / "pest-control-catalog.php"
...
def main() -> None:
    if not PROMPTS.is_file():
        subprocess.run([sys.executable, str(ROOT / "assets" / "pest_control_icon_prompts.py")], check=True)
