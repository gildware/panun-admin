#!/usr/bin/env python3
"""Post-process AI-generated men's salon category + variant icons."""
...
PROMPTS = ROOT / "assets" / "data" / "mens-salon-icon-prompts.json"
...
def main() -> None:
    if not PROMPTS.is_file():
        subprocess.run([sys.executable, str(ROOT / "assets" / "mens_salon_icon_prompts.py")], check=True)
    ...
    print("All men's salon icons prepared.")
