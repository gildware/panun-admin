 ...
 *   python3 scripts/assets/home_appliances_photo_prompts.py
 ...
 *
 * Optional:
 *   HOME_APPLIANCES_DRY_RUN=1
 *   HOME_APPLIANCES_ONLY_SLUGS=ac-repair,cctv-installation
 */
...
$dryRun = filter_var(env('HOME_APPLIANCES_DRY_RUN', false), FILTER_VALIDATE_BOOLEAN);
...
$liveConnection = 'live_home_appliances';
...
if ($onlySlugs === []) {
    ...
    echo "Skipped obsolete deactivation (HOME_APPLIANCES_ONLY_SLUGS is set).\n";
}
