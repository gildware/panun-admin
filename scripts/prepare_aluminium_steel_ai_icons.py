#!/usr/bin/env python3
"""Post-process AI-generated Aluminium & Steel category + variant icons."""
...
PROMPTS = ROOT / "assets" / "data" / "aluminium-steel-icon-prompts.json"
...
def main() -> None:
    if not PROMPTS.is_file():
        subprocess.run([sys.executable, str(ROOT / "assets" / "aluminium_steel_icon_prompts.py")], check=True)
