...
class NotificationTriggerAuditTest extends TestCase
{
    ...
    {
        $customerOnly = ['booking_place', 'admin_booking_created', 'otp', 'provider_assign', 'refund', 'refund_bank_transfer', 'payment_failed', 'add_fund_wallet', 'wallet_deducted', 'referral_earning', 'loyalty_point', 'loyalty_point_convert', 'customer_review_approved', 'review_published'];
    ...
    {
        $providerOnly = ['new_service_request_arrived', 'admin_booking_assigned', 'booking_assigned_to_provider', 'service_request_approve', 'service_request_deny', 'showcase_submitted', 'showcase_approve', 'showcase_deny', 'widthdraw_request_approve', 'widthdraw_request_deny', 'withdraw_request_submitted', 'admin_payable', 'settlement_received', 'review_approved', 'provider_review_published', 'provider_removed_from_booking', 'open_request_published', 'open_request_reminder'];
