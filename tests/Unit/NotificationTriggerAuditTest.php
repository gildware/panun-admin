...
class NotificationTriggerAuditTest extends TestCase
{
    ...
    {
        $customerOnly = ['booking_place', 'otp', 'provider_assign', 'refund', 'payment_failed', 'add_fund_wallet', 'wallet_deducted', 'referral_earning', 'loyalty_point', 'booking_reminder'];
    ...
    {
        $providerOnly = ['new_service_request_arrived', 'booking_assigned_to_provider', 'service_request_approve', 'service_request_deny', 'widthdraw_request_approve', 'widthdraw_request_deny', 'admin_payable', 'settlement_received'];
