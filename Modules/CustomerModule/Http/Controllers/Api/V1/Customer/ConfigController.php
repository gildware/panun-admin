...
class ConfigController extends Controller
{
    ...
    private function buildConfigurationResponse(): JsonResponse
    {
        ...
        return response()->json(response_formatter(DEFAULT_200, [
            'default_location' => [
                'latitude' => (business_config('address_latitude', 'business_information'))->live_values ?? 34.0837,
                'longitude' => (business_config('address_longitude', 'business_information'))->live_values ?? 74.7973
            ],
            ...
            'referral_share_message_template' => business_config_scalar(
