        ...
        return [
            ...
            'source_guides' => [
                ...
                self::leadSourceGuide(
                    ...
                    'web',
                    'inbox',
                    'Open any lead to see the full picture. Hero = summary. Main cards = type-specific info. Sidebar = quick actions and schedule. Activity = comments, follow-up history, change log.',
                    [
                        ...
                        'Main: Source & Ad Source, type info card, Initial Remarks',
                        'Sidebar: Assigned To, Schedule (Received On + Next Follow-up), quick actions',
                        'Activity pills: Comments | Follow-ups (count) | Change History',
                    ],
                    [
                        'Updating only Initial Remarks and never adding follow-up rows for each call',
                    ...
                    [
                        ...
                        'Read Initial Remarks + Follow-ups tab before dialling — know prior attempts',
                ...
                self::leadSourceGuide(
                    ...
                    [
                        ...
                        'Using Comments instead of Add follow-up for contact attempts',
                    ],
                    [
            ...
            'ui_maps' => [
                [
                    ...
                    'steps' => [
                        ...
                        ['label' => '6 Activity tabs', 'text' => 'Comments · Follow-ups (count) · Change History'],
                    ],
                ],
                [
            ...
            'remember' => [
                ...
                'Log every call/WA as Add follow-up → Taken — Follow-ups tab = contact count',
            ...
            'avoid' => [
                ...
                'Skipping follow-up rows and expecting auto attempt count',
            ...
            'questions' => [
                ...
                [
                    ...
                    'options' => [
                        ...
                        'Activity → Follow-ups tab count + history table — each Add follow-up → Taken → Call or WhatsApp row',
                        'Initial remarks only — follow-ups tab is for bookings',
                        'Change History tab counts phone calls',
                    ],
                    'correct' => 1,
                    'explain' => 'No auto counter. Log each touch with Add follow-up → Taken. Follow-ups tab shows count and history; remarks are a summary backup.',
                ],
                [
                    'id' => 'q32',
