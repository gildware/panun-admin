...
trait AdminMenuWithRoutes
{
    public function adminMenuWithRoutes()
    {
        $result = [
            ...
            [
                'route_name' => 'WhatsApp',
                'uri' => 'admin/whatsapp/conversations',
                'full_route' => url('admin/whatsapp/conversations'),
                'keywords' => 'WhatsApp, chat, conversations, messages',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Message_templates',
                'uri' => 'admin/whatsapp/booking-message-templates',
                'full_route' => url('admin/whatsapp/booking-message-templates'),
                'keywords' => 'message templates, WhatsApp, booking templates',
                'type' => 'menu',
            ],
            [
                'route_name' => 'WhatsApp_AI_support',
                'uri' => 'admin/whatsapp/ai-support',
                'full_route' => url('admin/whatsapp/ai-support'),
                'keywords' => 'WhatsApp AI, Gemini, chatbot, flow, prompt, tools',
                'type' => 'menu',
            ],
            [
                'route_name' => 'WhatsApp_Marketing',
                'uri' => 'admin/whatsapp/marketing/send',
                'full_route' => url('admin/whatsapp/marketing/send'),
                'keywords' => 'WhatsApp marketing, bulk, campaigns, templates, reports, Panun Kaergar',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Marketing_Templates',
                'uri' => 'admin/whatsapp/marketing/templates',
                'full_route' => url('admin/whatsapp/marketing/templates'),
                'keywords' => 'WhatsApp marketing templates, sync templates',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Marketing_Campaigns',
                'uri' => 'admin/whatsapp/marketing/campaigns',
                'full_route' => url('admin/whatsapp/marketing/campaigns'),
                'keywords' => 'WhatsApp marketing campaigns',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Marketing_Reports',
                'uri' => 'admin/whatsapp/marketing/reports',
                'full_route' => url('admin/whatsapp/marketing/reports'),
