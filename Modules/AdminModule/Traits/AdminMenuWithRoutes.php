    ...
    public function adminMenuWithRoutes()
    {
        $result = [
            ...
            [
                ...
                'uri' => 'admin/lead/reports?tab=inbound',
                'full_route' => url('admin/lead/reports?tab=inbound'),
                "page_title" => 'Lead_Reports',
                "keywords" => 'Reports, Lead Reports, leads',
                "type" => 'menu',
                "module" => "reports",
                "sorting" => 5,
            ],
            ...
            [
                ...
                'uri' => 'admin/customer-cart',
                'full_route' => url('admin/customer-cart'),
