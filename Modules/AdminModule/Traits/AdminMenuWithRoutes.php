    ...
    public function adminMenuWithRoutes()
    {
        $result = [
            [
                ...
                'uri' => 'admin/dashboard',
                'full_route' => url('admin/dashboard'),
            ...
            [
                ...
                'uri' => 'admin/booking/list?booking_status=all&service_type=all',
                'full_route' => url('admin/booking/list?booking_status=all&service_type=all'),
            ...
            [
                ...
                'page_title' => 'Add_New_Booking',
                'keywords' => 'One-time booking, Add New Booking, new booking, Bookings',
                'type' => 'menu',
                'module' => 'bookings',
                'sorting' => 10,
            ],
            [
                'route_name' => 'Repeat_booking',
                'uri' => 'admin/booking/repeat/list?booking_status=all&service_type=all',
                'full_route' => url('admin/booking/repeat/list?booking_status=all&service_type=all'),
                'page_title' => 'Repeat_booking',
                'keywords' => 'Repeat booking, Repeat bookings, recurring booking, weekly booking, monthly booking, series booking',
                'type' => 'menu',
                'module' => 'bookings',
                'sorting' => 3.15,
            ],
            [
                'route_name' => 'Add_repeat_booking',
                'uri' => 'admin/booking/create/repeat',
                'full_route' => url('admin/booking/create/repeat'),
                'page_title' => 'Add_repeat_booking',
                'keywords' => 'Add repeat booking, Repeat booking, new series, Bookings',
                'type' => 'menu',
                'module' => 'bookings',
                'sorting' => 10.1,
            ],
            ...
            [
                ...
                'keywords' => 'Add New Bidding, new bidding, customized request, Bookings',
                'type' => 'menu',
                'module' => 'bookings',
                'sorting' => 11,
            ],
            [
                'route_name' => 'social_inbox_whatsapp',
                'uri' => 'admin/social-inbox/whatsapp/conversations',
                'full_route' => url('admin/social-inbox/whatsapp/conversations'),
                'page_title' => 'WhatsApp',
                'keywords' => 'WhatsApp, chat, conversations, messages, social inbox',
                'type' => 'menu',
            ],
            [
                'route_name' => 'social_inbox_instagram',
                'uri' => 'admin/social-inbox/instagram/conversations',
                'full_route' => url('admin/social-inbox/instagram/conversations'),
                'page_title' => 'Instagram',
                'keywords' => 'Instagram, chat, conversations, messages, social inbox, DM',
                'type' => 'menu',
            ],
            [
                'route_name' => 'social_inbox_facebook',
                'uri' => 'admin/social-inbox/facebook/conversations',
                'full_route' => url('admin/social-inbox/facebook/conversations'),
                'page_title' => 'Facebook_Messenger',
                'keywords' => 'Facebook, Messenger, chat, conversations, messages, social inbox',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Message_templates',
                'uri' => 'admin/social-inbox/whatsapp/booking-message-templates',
                'full_route' => url('admin/social-inbox/whatsapp/booking-message-templates'),
                'keywords' => 'message templates, WhatsApp, booking templates',
                'type' => 'menu',
            ],
            [
                'route_name' => 'WhatsApp_AI_support',
                'uri' => 'admin/social-inbox/whatsapp/ai-support',
                'full_route' => url('admin/social-inbox/whatsapp/ai-support'),
                'keywords' => 'WhatsApp AI, Gemini, chatbot, flow, prompt, tools',
                'type' => 'menu',
            ],
            [
            ...
            [
                ...
                'keywords' => 'WhatsApp marketing, bulk, campaigns, templates, reports, Panun Kaergar',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Marketing_Templates',
                'uri' => 'admin/social-inbox/whatsapp/marketing/templates',
                'full_route' => url('admin/social-inbox/whatsapp/marketing/templates'),
                'keywords' => 'WhatsApp marketing templates, sync templates',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Marketing_Campaigns',
                'uri' => 'admin/social-inbox/whatsapp/marketing/campaigns',
                'full_route' => url('admin/social-inbox/whatsapp/marketing/campaigns'),
                'keywords' => 'WhatsApp marketing campaigns',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Marketing_Reports',
                'uri' => 'admin/social-inbox/whatsapp/marketing/reports',
                'full_route' => url('admin/social-inbox/whatsapp/marketing/reports'),
                'keywords' => 'WhatsApp marketing reports',
                'type' => 'menu',
            ],
            [
            ...
            [
                ...
                'keywords' => 'Feedback Configuration, provider feedback, Providers',
                'type' => 'menu',
            ],
            [
            ...
            [
                ...
                'full_route' => url('admin/withdraw/method/list'),
                "page_title" => 'Withdraw method setup',
                "keywords" => 'Withdraw method setup, withdraw methods, Withdraws',
                "type" => 'menu',
            ],
            [
            ...
            [
                ...
                "keywords" => 'add new service, Services',
                "type" => 'menu',
                "module" => "services",
                "sorting" => 2,
            ],
            ...
            [
                ...
                "keywords" => 'Subscribed Newsletter, newsletter, customers',
                "type" => 'menu',
            ],
            [
            ...
            [
                'route_name' => 'Ledger',
                'uri' => 'admin/ledger',
                'full_route' => url('admin/ledger'),
                'keywords' => 'ledger, accounting, transactions',
                'type' => 'menu',
            ],
            [
            ...
            [
                'route_name' => 'Inbound_Lead_Reports',
                'uri' => 'admin/lead/reports/inbound',
                'full_route' => url('admin/lead/reports/inbound'),
                "page_title" => 'Inbound_Lead_Reports',
                "keywords" => 'Reports, Inbound Lead Reports, leads',
                "type" => 'menu',
                "module" => "reports",
                "sorting" => 5,
            ],
            [
                'route_name' => 'Outbound_Lead_Reports',
                'uri' => 'admin/lead/reports/outbound',
                'full_route' => url('admin/lead/reports/outbound'),
                "page_title" => 'Outbound_Lead_Reports',
                "keywords" => 'Reports, Outbound Lead Reports, leads',
                "type" => 'menu',
                "module" => "reports",
                "sorting" => 6,
            ],
            [
                'route_name' => 'User_Report',
                'uri' => 'admin/lead/reports/user',
                'full_route' => url('admin/lead/reports/user'),
                "page_title" => 'User_Report',
                "keywords" => 'Reports, User Report, leads',
                "type" => 'menu',
                "module" => "reports",
                "sorting" => 7,
            ],
            [
                'route_name' => 'Progress_Report',
            ...
            [
                ...
                "keywords" => 'Keyword Search, search analytics, Analytics',
                "type" => 'menu',
            ],
            [
                ...
                "keywords" => 'Customer Search, analytics, Analytics',
                "type" => 'menu',
            ],
            [
            ...
            [
                'route_name' => 'Add-on_Activation',
                'uri' => 'admin/add-on-activation/index',
                'full_route' => url('admin/add-on-activation/index'),
                'keywords' => 'Add-on Activation, addon activation, modules, system addon',
                'type' => 'menu',
            ],
            [
            ...
            [
                ...
                "keywords" => 'Notification Channel, notification settings, Settings management',
                "type" => 'menu',
            ],
            [
                'route_name' => '404_Logs',
            ...
            [
                'route_name' => 'Reset_Operational_Data',
                'uri' => 'admin/system-maintenance/data-reset',
                'full_route' => url('admin/system-maintenance/data-reset'),
                'keywords' => 'Reset Operational Data, data reset, maintenance, system setup',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Data_Transfer',
                'uri' => 'admin/data-transfer',
                'full_route' => url('admin/data-transfer'),
                'keywords' => 'Data Transfer, import export, migration, system setup',
                'type' => 'menu',
            ],
            [
            ...
            [
                'route_name' => 'Mobile_App_AI',
                'uri' => 'admin/mobile-app-management/ai',
            ...
            [
                ...
                'keywords' => 'Mobile App Management, home page, customer app',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Mobile_App_Icons',
                'uri' => 'admin/mobile-app-management/icons',
                'full_route' => url('admin/mobile-app-management/icons'),
                'page_title' => 'Icons_and_images',
                'keywords' => 'Mobile App Management, icons, logos, mobile app',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Leads',
                ...
                "page_title" => 'Leads',
                "keywords" => 'Leads, lead list, Lead Management, CRM',
                "type" => 'menu',
            ],
            [
            ...
            [
                ...
                "keywords" => 'Outbound Enquiry, outbound, leads, Lead Management',
                "type" => 'menu',
            ],
            [
            ...
            [
                ...
                "keywords" => 'Lead Configuration, leads settings, Lead Management',
                "type" => 'menu',
            ],
            [
            ...
            [
                'route_name' => 'System_Logs',
                'uri' => 'admin/system-logs',
                'full_route' => url('admin/system-logs'),
                'page_title' => 'System_Logs',
                'keywords' => 'System logs, errors, debug',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Razorpay_webhook_logs',
                'uri' => 'admin/transaction/razorpay-webhooks',
                'full_route' => url('admin/transaction/razorpay-webhooks'),
                'page_title' => 'Razorpay_webhook_logs',
                'keywords' => 'Razorpay, webhooks, transactions',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Customer_Cart',
                'uri' => 'admin/customer-cart/list',
                'full_route' => url('admin/customer-cart/list'),
                'page_title' => 'Customer_Cart',
                'keywords' => 'Customer cart, abandoned cart',
                'type' => 'menu',
            ],
            [
                'route_name' => 'Talk_With_AI',
                'uri' => 'admin/business-ai',
                'full_route' => url('admin/business-ai'),
                'page_title' => 'Talk_With_AI',
                'keywords' => 'Business AI, chat, assistant',
                'type' => 'menu',
            ],
            [
            ...
            [
                'route_name' => 'Push Notification Settings',
                'uri' => 'admin/configuration/get-notification-setting?type=customers',
                'full_route' => url('admin/configuration/get-notification-setting?type=customers'),
                'page_title' => 'Push Notification',
                'keywords' => 'Push notification, notification messages, customers, providers, configuration',
                'type' => 'menu',
            ],
        ];
