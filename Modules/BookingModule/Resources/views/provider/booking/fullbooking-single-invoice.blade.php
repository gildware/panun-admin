    ...
    <div class="invoice d-flex flex-column">
        <div>
            <table>
                <tbody>
                @php
                    $invoice_business_name = business_config('business_name','business_information');
                @endphp
                <tr>
            ...
            @php
                $customer_name = $booking->booking->customer ? $booking?->booking?->customer?->first_name.' '.$booking?->booking?->customer?->last_name : $booking?->booking?->service_address?->contact_person_name;
                $customer_phone = $booking->booking->customer ? $booking?->booking?->customer?->phone : $booking?->booking?->service_address?->contact_person_number;
            @endphp
...
{{--                                </div>--}}
                    ...
                    <table cellspacing="0" cellpadding="0">
                        ...
                        @php
                            ...
                            $fbsInvSvcDiscP = round(($booking->total_discount_amount ?? 0) + get_booking_extra_service_line_discount_total($booking), 2);
