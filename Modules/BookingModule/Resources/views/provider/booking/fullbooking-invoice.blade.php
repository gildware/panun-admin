...
{{--                                </div>--}}
                    ...
                    <table cellspacing="0" cellpadding="0">
                        ...
                        @php($fbInvSvcDiscP = round((float) ($booking->total_discount_amount ?? 0) + get_booking_extra_service_line_discount_total($booking), 2))
                        @if($fbInvSvcDiscP > 0)
                        <tr>
                            <td colspan="3"></td>
                            <td>{{translate('Discount')}}</td>
                            <td>- {{with_currency_symbol($fbInvSvcDiscP)}}</td>
                        </tr>
                        @endif
