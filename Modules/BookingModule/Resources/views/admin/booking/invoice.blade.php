            ...
            <div class="white-box-content border rounded-12 border">
                    ...
                    <tr>
                        ...
                        <td class="border-bottom">
                            <div class="text-right">
                                ...
                                <h5 style="font-size:20px; font-weight: 700;margin:0;color:#007bff">{{with_currency_symbol(get_booking_total_amount_for_display($booking))}}</h5>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <div class="p-3">
                    ...
                    <table cellspacing="0" cellpadding="0">
                        ...
                        @endforeach
                        @foreach(($booking->extra_services ?? []) as $extraIndex => $extra)
                            <tr>
                                <td class="border-bottom text-left">{{ (strlen(count($booking->detail)+$extraIndex+1)<2?'0':'').(count($booking->detail)+$extraIndex+1) }}</td>
                                <td class="border-bottom text-left">
                                    <div>{{ $extra->title }}</div>
                        ...
                        <?php
                            ...
                            $invGrandTotal = round(get_booking_total_amount_for_display($booking), 2);
