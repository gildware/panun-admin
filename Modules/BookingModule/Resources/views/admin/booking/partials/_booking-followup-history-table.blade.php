@php
    ...
    $tableClass = trim('data-table booking-followup-history-table lead-followup-history-table mb-0 '.($tableClass ?? ''));
@endphp
@if($showSectionLabel)
                ...
                @foreach($followups as $followup)
                    ...
                    @if($hasRecording)
                        <tr class="voice-call-details-row d-none">
                            <td colspan="{{ $showActionColumn ? 10 : 9 }}" class="p-0 border-0">
