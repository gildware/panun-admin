    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body pt-5 p-md-5">
                ...
                <h3 class="text-center mb-2 fw-medium" id="deleteFollowupModalLabel">
                    {{ translate('Are_you_sure_you_want_to_delete_this_item') }}
                </h3>
                <p class="text-center fs-12 fw-medium text-muted mb-1" id="deleteFollowupModalItem"></p>
                ...
                <div class="d-flex justify-content-center gap-3 mt-4">
                    ...
                    <button type="button" class="btn btn-danger" id="deleteFollowupConfirmBtn">
                        {{ translate('Delete') }}
                    </button>
                </div>
            </div>
