...
class LeadCommentAttachment extends Model
{
    protected $fillable = [
        'lead_comment_id',
        'uploaded_by',
    ...
    {
        return $this->belongsTo(LeadComment::class, 'lead_comment_id');
    }
    ...
    {
        $path = StoragePathPrefix::apply('lead-comments/'.$this->stored_name);
    ...
    {
        return StoragePathPrefix::apply('lead-comments/'.$this->stored_name);
    }
}
