...
Route::group([
    ...
    Route::group([
        ...
        Route::post('conversations/chat/reply', [WhatsAppController::class, 'sendReply'])->middleware(['can:whatsapp_chat_send_message'])->name('conversations.reply');
        Route::post('conversations/chat/reaction', [WhatsAppController::class, 'sendMessageReaction'])->middleware(['can:whatsapp_chat_send_message'])->name('conversations.reaction');
        ...
        Route::post('conversations/chat/send-template', [WhatsAppController::class, 'sendChatTemplate'])->middleware(['can:whatsapp_chat_send_message'])->name('conversations.chat.send-template');
        ...
        Route::post('conversations/chat/thread-tags', [WhatsAppController::class, 'updateThreadChatTags'])->middleware(['can:whatsapp_chat_manage_tags'])->name('conversations.thread-tags');
