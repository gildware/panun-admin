...
@section('title', translate('Mobile_App_Configuration'))
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-20">
                <div>
                    <h2 class="page-title mb-1">{{ translate('Mobile_App_Configuration') }}</h2>
                ...
                @foreach($tabs as $t)
                    <li class="nav-item">
                        <a class="nav-link {{ $tab === $t['id'] ? 'active' : '' }}"
                           href="{{ route('admin.mobile-app-configuration.index', ['tab' => $t['id']]) }}">
                            {{ $t['label'] }}
                        </a>
                    </li>
                @endforeach
            ...
            @if($tab === 'ai_config')
                <form action="{{ route('admin.mobile-app-configuration.ai-config.update') }}" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-body p-0" style="max-height:70vh;overflow:auto;">
                                <ul class="list-group list-group-flush">
                                    @forelse($conversations as $conv)
                                        ...
                                        @endphp
                                        <a href="{{ route('admin.mobile-app-configuration.index', ['tab' => 'ai_chat', 'conversation_id' => $conv->id]) }}"
